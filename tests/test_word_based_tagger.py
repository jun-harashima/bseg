...
class TestModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.word_to_index = {'<PAD>': 0, '<UNK>': 1, '人参': 2, 'を': 3,
                              '切る': 4, 'ざっくり': 5, '葱': 6, 'は': 7,
                              '細く': 8, '刻む': 9}
        self.model = WordBasedTagger(2, 4, [len(self.word_to_index)],
                                     self.tag_to_index, batch_size=3)
    ...
    def test__split(self):
        ...
        model = WordBasedTagger(2, 4, [len(self.word_to_index)],
                                self.tag_to_index, batch_size=4)
